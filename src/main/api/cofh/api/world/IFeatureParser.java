...
public interface IFeatureParser {
	...
	/**
	 * Parse a {@link com.google.gson.JsonObject} for registration with an with an {@link IFeatureHandler}.
	 * 
	 * @param featureName
	 ...
	 * @param log
	 *            The {@link org.apache.logging.log4j.Logger} to log debug/error/etc. messages to.
